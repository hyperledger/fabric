...
import (
	...
	bccsp "github.com/hyperledger/fabric/v2/bccsp/utils"
	...
	lifecyclemocks "github.com/hyperledger/fabric/v2/core/cclifecycle/mocks"
	"github.com/hyperledger/fabric/v2/core/common/ccprovider"
	"github.com/hyperledger/fabric/v2/discovery"
	disc "github.com/hyperledger/fabric/v2/discovery/client"
	...
	"github.com/hyperledger/fabric/v2/discovery/support/mocks"
	"github.com/hyperledger/fabric/v2/gossip/api"
	gcommon "github.com/hyperledger/fabric/v2/gossip/common"
	gdisc "github.com/hyperledger/fabric/v2/gossip/discovery"
...
func buildBinaries() error {
	var err error
	cryptogen, err = gexec.Build("github.com/hyperledger/fabric/v2/cmd/cryptogen")
	if err != nil {
