...
func RunSBE(n *nwo.Network, orderer *nwo.Orderer, mode string) {
	...
	sess, err := n.PeerCliUserSession(peerOrg1, "User1", commands.ChaincodeInvoke{
	...
	sess, err = n.PeerCliUserSession(peerOrg2, "User1", commands.ChaincodeQuery{
		ChannelID: "testchannel",
		Name:      "mycc",
	...
	sess, err = n.PeerCliUserSession(peerOrg1, "User1", commands.ChaincodeQuery{
		ChannelID: "testchannel",
		Name:      "mycc",
	...
	sess, err = n.PeerCliUserSession(peerOrg2, "User1", commands.ChaincodeInvoke{
		ChannelID: "testchannel",
		Orderer:   n.OrdererAddress(orderer, nwo.ListenPort),
		Name:      "mycc",
