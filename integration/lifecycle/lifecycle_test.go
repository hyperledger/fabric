...
var _ = Describe("Lifecycle", func() {
	...
	It("deploys and executes chaincode using _lifecycle and upgrades it", func() {
		...
		sess, err := network.PeerCliAdminSession(testPeers[0], commands.ChaincodeGetInstalledPackage{
		...
		sess, err = network.PeerCliUserSession(org3peer0, "User1", commands.ChaincodeInvoke{
			ChannelID:     "testchannel",
