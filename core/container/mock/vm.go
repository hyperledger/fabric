...
func (fake *VM) Build(arg1 ccintf.CCID, arg2 string, arg3 string, arg4 string, arg5 string, arg6 []byte) error {
	var arg6Copy []byte
	if arg6 != nil {
...
func (fake *VM) BuildCalls(stub func(ccintf.CCID, string, string, string, string, []byte) error) {
	fake.buildMutex.Lock()
	defer fake.buildMutex.Unlock()
	fake.BuildStub = stub
}

func (fake *VM) BuildArgsForCall(i int) (ccintf.CCID, string, string, string, string, []byte) {
	fake.buildMutex.RLock()
	defer fake.buildMutex.RUnlock()
