...
// ExecuteQueryWithBookmarkAndLimit provides a mock function with given fields: namespace, query, bookmark, limit
func (_m *QueryExecutor) ExecuteQueryWithBookmarkAndLimit(namespace string, query string, bookmark string, limit int32) (coreledger.QueryResultsIterator, error) {
	ret := _m.Called(namespace, query, bookmark, limit)
	...
	if rf, ok := ret.Get(0).(func(string, string, string, int32) coreledger.QueryResultsIterator); ok {
		r0 = rf(namespace, query, bookmark, limit)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(string, string, string, int32) error); ok {
		r1 = rf(namespace, query, bookmark, limit)
	} else {
		r1 = ret.Error(1)
	}
...
// GetStateRangeScanIteratorWithLimit provides a mock function with given fields: namespace, startKey, endKey, limit
func (_m *QueryExecutor) GetStateRangeScanIteratorWithLimit(namespace string, startKey string, endKey string, limit int32) (coreledger.QueryResultsIterator, error) {
	ret := _m.Called(namespace, startKey, endKey, limit)

	var r0 coreledger.QueryResultsIterator
	if rf, ok := ret.Get(0).(func(string, string, string, int32) coreledger.QueryResultsIterator); ok {
		r0 = rf(namespace, startKey, endKey, limit)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(coreledger.QueryResultsIterator)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(string, string, string, int32) error); ok {
		r1 = rf(namespace, startKey, endKey, limit)
	} else {
		r1 = ret.Error(1)
	}
