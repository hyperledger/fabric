...
// GetStateRangeScanIteratorWithOptions provides a mock function with given fields: namespace, startKey, endKey, options
func (_m *QueryExecutor) GetStateRangeScanIteratorWithOptions(namespace string, startKey string, endKey string, options map[string]interface{}) (coreledger.QueryResultsIterator, error) {
	ret := _m.Called(namespace, startKey, endKey, options)

	var r0 coreledger.QueryResultsIterator
	if rf, ok := ret.Get(0).(func(string, string, string, map[string]interface{}) coreledger.QueryResultsIterator); ok {
		r0 = rf(namespace, startKey, endKey, options)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(coreledger.QueryResultsIterator)
		}
	...
	if rf, ok := ret.Get(1).(func(string, string, string, map[string]interface{}) error); ok {
		r1 = rf(namespace, startKey, endKey, options)
	} else {
		r1 = ret.Error(1)
	}
