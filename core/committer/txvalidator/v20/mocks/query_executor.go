...
import commonledger "github.com/hyperledger/fabric/common/ledger"
...
func (_m *QueryExecutor) ExecuteQuery(namespace string, query string) (commonledger.ResultsIterator, error) {
	ret := _m.Called(namespace, query)

	var r0 commonledger.ResultsIterator
	if rf, ok := ret.Get(0).(func(string, string) commonledger.ResultsIterator); ok {
		r0 = rf(namespace, query)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(commonledger.ResultsIterator)
		}
	}
...
func (_m *QueryExecutor) ExecuteQueryOnPrivateData(namespace string, collection string, query string) (commonledger.ResultsIterator, error) {
	ret := _m.Called(namespace, collection, query)

	var r0 commonledger.ResultsIterator
	if rf, ok := ret.Get(0).(func(string, string, string) commonledger.ResultsIterator); ok {
...
func (_m *QueryExecutor) ExecuteQueryWithMetadata(namespace string, query string, metadata map[string]interface{}) (ledger.QueryResultsIterator, error) {
	ret := _m.Called(namespace, query, metadata)

	var r0 ledger.QueryResultsIterator
	if rf, ok := ret.Get(0).(func(string, string, map[string]interface{}) ledger.QueryResultsIterator); ok {
		r0 = rf(namespace, query, metadata)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(ledger.QueryResultsIterator)
		}
	}
...
func (_m *QueryExecutor) GetPrivateDataRangeScanIterator(namespace string, collection string, startKey string, endKey string) (commonledger.ResultsIterator, error) {
	ret := _m.Called(namespace, collection, startKey, endKey)

	var r0 commonledger.ResultsIterator
	if rf, ok := ret.Get(0).(func(string, string, string, string) commonledger.ResultsIterator); ok {
...
func (_m *QueryExecutor) GetStateRangeScanIterator(namespace string, startKey string, endKey string) (commonledger.ResultsIterator, error) {
...
func (_m *QueryExecutor) GetStateRangeScanIteratorWithMetadata(namespace string, startKey string, endKey string, metadata map[string]interface{}) (ledger.QueryResultsIterator, error) {
	ret := _m.Called(namespace, startKey, endKey, metadata)

	var r0 ledger.QueryResultsIterator
	if rf, ok := ret.Get(0).(func(string, string, string, map[string]interface{}) ledger.QueryResultsIterator); ok {
