...
func (fake *TxSimulator) ExecuteQueryWithBookmarkAndLimit(arg1 string, arg2 string, arg3 string, arg4 int32) (ledger.QueryResultsIterator, error) {
...
func (fake *TxSimulator) ExecuteQueryWithBookmarkAndLimitCalls(stub func(string, string, string, int32) (ledger.QueryResultsIterator, error)) {
	fake.executeQueryWithBookmarkAndLimitMutex.Lock()
...
func (fake *TxSimulator) ExecuteQueryWithBookmarkAndLimitReturns(result1 ledger.QueryResultsIterator, result2 error) {
	fake.executeQueryWithBookmarkAndLimitMutex.Lock()
	defer fake.executeQueryWithBookmarkAndLimitMutex.Unlock()
...
func (fake *TxSimulator) ExecuteQueryWithBookmarkAndLimitReturnsOnCall(i int, result1 ledger.QueryResultsIterator, result2 error) {
	fake.executeQueryWithBookmarkAndLimitMutex.Lock()
	defer fake.executeQueryWithBookmarkAndLimitMutex.Unlock()
	fake.ExecuteQueryWithBookmarkAndLimitStub = nil
...
func (fake *TxSimulator) GetStateRangeScanIteratorWithLimit(arg1 string, arg2 string, arg3 string, arg4 int32) (ledger.QueryResultsIterator, error) {
...
func (fake *TxSimulator) GetStateRangeScanIteratorWithLimitCalls(stub func(string, string, string, int32) (ledger.QueryResultsIterator, error)) {
	fake.getStateRangeScanIteratorWithLimitMutex.Lock()
...
func (fake *TxSimulator) GetStateRangeScanIteratorWithLimitReturns(result1 ledger.QueryResultsIterator, result2 error) {
	fake.getStateRangeScanIteratorWithLimitMutex.Lock()
	defer fake.getStateRangeScanIteratorWithLimitMutex.Unlock()
...
func (fake *TxSimulator) GetStateRangeScanIteratorWithLimitReturnsOnCall(i int, result1 ledger.QueryResultsIterator, result2 error) {
	fake.getStateRangeScanIteratorWithLimitMutex.Lock()
	defer fake.getStateRangeScanIteratorWithLimitMutex.Unlock()
	fake.GetStateRangeScanIteratorWithLimitStub = nil
