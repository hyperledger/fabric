...
func (fake *QueryExecutor) GetStateRangeScanIteratorWithOptions(arg1 string, arg2 string, arg3 string, arg4 map[string]interface{}) (ledger.QueryResultsIterator, error) {
...
func (fake *QueryExecutor) GetStateRangeScanIteratorWithOptionsCalls(stub func(string, string, string, map[string]interface{}) (ledger.QueryResultsIterator, error)) {
	fake.getStateRangeScanIteratorWithOptionsMutex.Lock()
...
func (fake *QueryExecutor) GetStateRangeScanIteratorWithOptionsReturns(result1 ledger.QueryResultsIterator, result2 error) {
	fake.getStateRangeScanIteratorWithOptionsMutex.Lock()
	defer fake.getStateRangeScanIteratorWithOptionsMutex.Unlock()
...
func (fake *QueryExecutor) GetStateRangeScanIteratorWithOptionsReturnsOnCall(i int, result1 ledger.QueryResultsIterator, result2 error) {
	fake.getStateRangeScanIteratorWithOptionsMutex.Lock()
	defer fake.getStateRangeScanIteratorWithOptionsMutex.Unlock()
	fake.GetStateRangeScanIteratorWithOptionsStub = nil
