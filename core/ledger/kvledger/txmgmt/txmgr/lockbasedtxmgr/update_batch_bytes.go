...
func (bb *UpdatesBytesBuilder) DeterministicBytesForPubAndHashUpdates(u *privacyenabledstate.UpdateBatch) ([]byte, error) {
...
func (bb *UpdatesBytesBuilder) buildForColls(colls privacyenabledstate.NsBatch) []*KVWriteProto {
