...
func (*PvtdataKeys) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7ef096ccb746705, []int{0}
}
...
func (*Collections) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7ef096ccb746705, []int{1}
}
...
func (*KeysAndHashes) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7ef096ccb746705, []int{2}
}
...
func (*KeyAndHash) Descriptor() ([]byte, []int) {
	return fileDescriptor_f7ef096ccb746705, []int{3}
}
...
func init() { proto.RegisterFile("pvtdata_key.proto", fileDescriptor_f7ef096ccb746705) }

var fileDescriptor_f7ef096ccb746705 = []byte{
