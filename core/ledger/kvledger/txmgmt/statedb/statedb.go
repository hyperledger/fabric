...
type VersionedDBProvider interface {
	...
	// BootstrapDBFromSnapshot loads the public state and pvtdata hashes from the snapshot files previously
	// generated by using the FullScanIterator
	BootstrapDBFromState(id string, savepoint *version.Height, itr FullScanIterator, dbValueFormat byte) error
