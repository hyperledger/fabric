...
// The test data was generated by v1.1 code https://github.com/hyperledger/fabric/v3/blob/release-1.1/core/ledger/kvledger/tests/v11_generate_test.go#L22
...
// For v1.1, the sample ledger data was generated by https://github.com/hyperledger/fabric/v3/blob/release-1.1/core/ledger/kvledger/tests/v11_generate_test.go#L22
// This generate function constructed two ledgers and populateed the ledgers using this code
// (https://github.com/hyperledger/fabric/v3/blob/release-1.1/core/ledger/kvledger/tests/sample_data_helper.go#L55)
...
// (https://github.com/hyperledger/fabric/v3/blob/release-1.3/core/ledger/kvledger/tests/sample_data_helper.go#L55)
