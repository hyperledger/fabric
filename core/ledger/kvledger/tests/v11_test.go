...
func TestV11(t *testing.T) {
	...
	// drop blkstore-index folder and re-initialize ledger. This time, it causes panic because historydb is in 1.1 format
	...
	// drop historydb and re-initialize ledger
