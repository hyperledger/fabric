...
import (
	...
	"github.com/hyperledger/fabric/v3/core/ledger/confighistory/confighistorytest"
	"github.com/hyperledger/fabric/v3/core/ledger/internal/version"
	kvledgermock "github.com/hyperledger/fabric/v3/core/ledger/kvledger/mock"
	"github.com/hyperledger/fabric/v3/core/ledger/kvledger/msgs"
...
func TestGenerateSnapshotErrors(t *testing.T) {
	...
	t.Run("block store returns error", func(t *testing.T) {
		...
		require.Contains(t, errStackTrace, "github.com/hyperledger/fabric/v3/common/ledger/blkstorage")
	})
	...
	t.Run("config history mgr returns error", func(t *testing.T) {
		...
		errStackTrace := fmt.Sprintf("%+v", err)
		require.Contains(t, errStackTrace, "internal leveldb error while obtaining db iterator")
		require.Contains(t, errStackTrace, "github.com/hyperledger/fabric/v3/core/ledger/confighistory")
	})
