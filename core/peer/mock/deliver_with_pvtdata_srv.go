...
type DeliverWithPrivateDataServer struct {
	...
	SendStub        func(*peera.DeliverResponse) error
	sendMutex       sync.RWMutex
	sendArgsForCall []struct {
		arg1 *peera.DeliverResponse
	}
	sendReturns struct {
		result1 error
	}
...
func (fake *DeliverWithPrivateDataServer) Context() context.Context {
...
func (fake *DeliverWithPrivateDataServer) ContextCallCount() int {
	fake.contextMutex.RLock()
	defer fake.contextMutex.RUnlock()
	return len(fake.contextArgsForCall)
}

func (fake *DeliverWithPrivateDataServer) ContextCalls(stub func() context.Context) {
	fake.contextMutex.Lock()
	defer fake.contextMutex.Unlock()
	fake.ContextStub = stub
}

func (fake *DeliverWithPrivateDataServer) ContextReturns(result1 context.Context) {
	fake.contextMutex.Lock()
	defer fake.contextMutex.Unlock()
...
func (fake *DeliverWithPrivateDataServer) ContextReturnsOnCall(i int, result1 context.Context) {
	fake.contextMutex.Lock()
	defer fake.contextMutex.Unlock()
	fake.ContextStub = nil
...
func (fake *DeliverWithPrivateDataServer) Recv() (*common.Envelope, error) {
	fake.recvMutex.Lock()
...
func (fake *DeliverWithPrivateDataServer) RecvCallCount() int {
	fake.recvMutex.RLock()
	defer fake.recvMutex.RUnlock()
	return len(fake.recvArgsForCall)
}

func (fake *DeliverWithPrivateDataServer) RecvCalls(stub func() (*common.Envelope, error)) {
	fake.recvMutex.Lock()
	defer fake.recvMutex.Unlock()
	fake.RecvStub = stub
}

func (fake *DeliverWithPrivateDataServer) RecvReturns(result1 *common.Envelope, result2 error) {
	fake.recvMutex.Lock()
	defer fake.recvMutex.Unlock()
	fake.RecvStub = nil
...
func (fake *DeliverWithPrivateDataServer) RecvReturnsOnCall(i int, result1 *common.Envelope, result2 error) {
	fake.recvMutex.Lock()
	defer fake.recvMutex.Unlock()
	fake.RecvStub = nil
...
func (fake *DeliverWithPrivateDataServer) RecvMsg(arg1 interface{}) error {
...
func (fake *DeliverWithPrivateDataServer) RecvMsgCallCount() int {
	fake.recvMsgMutex.RLock()
	defer fake.recvMsgMutex.RUnlock()
	return len(fake.recvMsgArgsForCall)
}

func (fake *DeliverWithPrivateDataServer) RecvMsgCalls(stub func(interface{}) error) {
	fake.recvMsgMutex.Lock()
	defer fake.recvMsgMutex.Unlock()
	fake.RecvMsgStub = stub
}

func (fake *DeliverWithPrivateDataServer) RecvMsgArgsForCall(i int) interface{} {
	fake.recvMsgMutex.RLock()
	defer fake.recvMsgMutex.RUnlock()
...
func (fake *DeliverWithPrivateDataServer) RecvMsgReturns(result1 error) {
	fake.recvMsgMutex.Lock()
	defer fake.recvMsgMutex.Unlock()
...
func (fake *DeliverWithPrivateDataServer) RecvMsgReturnsOnCall(i int, result1 error) {
	fake.recvMsgMutex.Lock()
	defer fake.recvMsgMutex.Unlock()
	fake.RecvMsgStub = nil
...
func (fake *DeliverWithPrivateDataServer) Send(arg1 *peera.DeliverResponse) error {
	fake.sendMutex.Lock()
...
func (fake *DeliverWithPrivateDataServer) SendCallCount() int {
	fake.sendMutex.RLock()
	defer fake.sendMutex.RUnlock()
	return len(fake.sendArgsForCall)
}

func (fake *DeliverWithPrivateDataServer) SendCalls(stub func(*peera.DeliverResponse) error) {
	fake.sendMutex.Lock()
	defer fake.sendMutex.Unlock()
	fake.SendStub = stub
}

func (fake *DeliverWithPrivateDataServer) SendArgsForCall(i int) *peera.DeliverResponse {
	fake.sendMutex.RLock()
	defer fake.sendMutex.RUnlock()
...
func (fake *DeliverWithPrivateDataServer) SendReturns(result1 error) {
	fake.sendMutex.Lock()
	defer fake.sendMutex.Unlock()
	fake.SendStub = nil
...
func (fake *DeliverWithPrivateDataServer) SendReturnsOnCall(i int, result1 error) {
	fake.sendMutex.Lock()
	defer fake.sendMutex.Unlock()
	fake.SendStub = nil
...
func (fake *DeliverWithPrivateDataServer) SendHeader(arg1 metadata.MD) error {
...
func (fake *DeliverWithPrivateDataServer) SendHeaderCallCount() int {
	fake.sendHeaderMutex.RLock()
	defer fake.sendHeaderMutex.RUnlock()
	return len(fake.sendHeaderArgsForCall)
}

func (fake *DeliverWithPrivateDataServer) SendHeaderCalls(stub func(metadata.MD) error) {
	fake.sendHeaderMutex.Lock()
	defer fake.sendHeaderMutex.Unlock()
	fake.SendHeaderStub = stub
}

func (fake *DeliverWithPrivateDataServer) SendHeaderArgsForCall(i int) metadata.MD {
	fake.sendHeaderMutex.RLock()
	defer fake.sendHeaderMutex.RUnlock()
...
func (fake *DeliverWithPrivateDataServer) SendHeaderReturns(result1 error) {
	fake.sendHeaderMutex.Lock()
	defer fake.sendHeaderMutex.Unlock()
...
func (fake *DeliverWithPrivateDataServer) SendHeaderReturnsOnCall(i int, result1 error) {
	fake.sendHeaderMutex.Lock()
	defer fake.sendHeaderMutex.Unlock()
	fake.SendHeaderStub = nil
...
func (fake *DeliverWithPrivateDataServer) SendMsg(arg1 interface{}) error {
...
func (fake *DeliverWithPrivateDataServer) SendMsgCallCount() int {
	fake.sendMsgMutex.RLock()
	defer fake.sendMsgMutex.RUnlock()
	return len(fake.sendMsgArgsForCall)
}

func (fake *DeliverWithPrivateDataServer) SendMsgCalls(stub func(interface{}) error) {
	fake.sendMsgMutex.Lock()
	defer fake.sendMsgMutex.Unlock()
	fake.SendMsgStub = stub
}

func (fake *DeliverWithPrivateDataServer) SendMsgArgsForCall(i int) interface{} {
	fake.sendMsgMutex.RLock()
	defer fake.sendMsgMutex.RUnlock()
...
func (fake *DeliverWithPrivateDataServer) SendMsgReturns(result1 error) {
	fake.sendMsgMutex.Lock()
	defer fake.sendMsgMutex.Unlock()
...
func (fake *DeliverWithPrivateDataServer) SendMsgReturnsOnCall(i int, result1 error) {
	fake.sendMsgMutex.Lock()
	defer fake.sendMsgMutex.Unlock()
	fake.SendMsgStub = nil
...
func (fake *DeliverWithPrivateDataServer) SetHeader(arg1 metadata.MD) error {
...
func (fake *DeliverWithPrivateDataServer) SetHeaderCallCount() int {
	fake.setHeaderMutex.RLock()
	defer fake.setHeaderMutex.RUnlock()
	return len(fake.setHeaderArgsForCall)
}

func (fake *DeliverWithPrivateDataServer) SetHeaderCalls(stub func(metadata.MD) error) {
	fake.setHeaderMutex.Lock()
	defer fake.setHeaderMutex.Unlock()
	fake.SetHeaderStub = stub
}

func (fake *DeliverWithPrivateDataServer) SetHeaderArgsForCall(i int) metadata.MD {
	fake.setHeaderMutex.RLock()
	defer fake.setHeaderMutex.RUnlock()
...
func (fake *DeliverWithPrivateDataServer) SetHeaderReturns(result1 error) {
	fake.setHeaderMutex.Lock()
	defer fake.setHeaderMutex.Unlock()
...
func (fake *DeliverWithPrivateDataServer) SetHeaderReturnsOnCall(i int, result1 error) {
	fake.setHeaderMutex.Lock()
	defer fake.setHeaderMutex.Unlock()
	fake.SetHeaderStub = nil
...
func (fake *DeliverWithPrivateDataServer) SetTrailer(arg1 metadata.MD) {
...
func (fake *DeliverWithPrivateDataServer) SetTrailerCallCount() int {
	fake.setTrailerMutex.RLock()
	defer fake.setTrailerMutex.RUnlock()
	return len(fake.setTrailerArgsForCall)
}

func (fake *DeliverWithPrivateDataServer) SetTrailerCalls(stub func(metadata.MD)) {
	fake.setTrailerMutex.Lock()
	defer fake.setTrailerMutex.Unlock()
	fake.SetTrailerStub = stub
}

func (fake *DeliverWithPrivateDataServer) SetTrailerArgsForCall(i int) metadata.MD {
	fake.setTrailerMutex.RLock()
	defer fake.setTrailerMutex.RUnlock()
...
func (fake *DeliverWithPrivateDataServer) Invocations() map[string][][]interface{} {
...
func (fake *DeliverWithPrivateDataServer) recordInvocation(key string, args []interface{}) {
