...
func (fake *Chain) Ledger() ledger.PeerLedger {
...
func (fake *Chain) LedgerCallCount() int {
	fake.ledgerMutex.RLock()
	defer fake.ledgerMutex.RUnlock()
	return len(fake.ledgerArgsForCall)
}

func (fake *Chain) LedgerCalls(stub func() ledger.PeerLedger) {
	fake.ledgerMutex.Lock()
	defer fake.ledgerMutex.Unlock()
	fake.LedgerStub = stub
}

func (fake *Chain) LedgerReturns(result1 ledger.PeerLedger) {
	fake.ledgerMutex.Lock()
	defer fake.ledgerMutex.Unlock()
	fake.LedgerStub = nil
...
func (fake *Chain) LedgerReturnsOnCall(i int, result1 ledger.PeerLedger) {
	fake.ledgerMutex.Lock()
	defer fake.ledgerMutex.Unlock()
	fake.LedgerStub = nil
