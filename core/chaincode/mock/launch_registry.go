...
type LaunchRegistry struct {
	LaunchingStub        func(cname string) (<-chan struct{}, error)
...
func (fake *LaunchRegistry) Launching(cname string) (<-chan struct{}, error) {
...
func (fake *LaunchRegistry) LaunchingReturns(result1 <-chan struct{}, result2 error) {
...
func (fake *LaunchRegistry) LaunchingReturnsOnCall(i int, result1 <-chan struct{}, result2 error) {
	fake.LaunchingStub = nil
