...
func (fake *ChaincodeDefinitionGetter) ChaincodeDefinition(arg1 string, arg2 ledger.SimpleQueryExecutor) (ccprovider.ChaincodeDefinition, error) {
...
func (fake *ChaincodeDefinitionGetter) ChaincodeDefinitionCalls(stub func(string, ledger.SimpleQueryExecutor) (ccprovider.ChaincodeDefinition, error)) {
	fake.chaincodeDefinitionMutex.Lock()
