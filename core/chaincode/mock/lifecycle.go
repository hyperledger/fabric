...
func (fake *Lifecycle) ChaincodeContainerInfo(arg1 string, arg2 ledger.SimpleQueryExecutor) (*ccprovider.ChaincodeContainerInfo, error) {
...
func (fake *Lifecycle) ChaincodeContainerInfoCalls(stub func(string, ledger.SimpleQueryExecutor) (*ccprovider.ChaincodeContainerInfo, error)) {
	fake.chaincodeContainerInfoMutex.Lock()
...
func (fake *Lifecycle) ChaincodeDefinition(arg1 string, arg2 ledger.SimpleQueryExecutor) (ccprovider.ChaincodeDefinition, error) {
...
func (fake *Lifecycle) ChaincodeDefinitionCalls(stub func(string, ledger.SimpleQueryExecutor) (ccprovider.ChaincodeDefinition, error)) {
	fake.chaincodeDefinitionMutex.Lock()
