...
func (fake *Lifecycle) ChaincodeDefinitionCalls(stub func(string, string, ledger.SimpleQueryExecutor) (ccprovider.ChaincodeDefinition, error)) {
	fake.chaincodeDefinitionMutex.Lock()
	defer fake.chaincodeDefinitionMutex.Unlock()
	fake.ChaincodeDefinitionStub = stub
}

func (fake *Lifecycle) ChaincodeDefinitionArgsForCall(i int) (string, string, ledger.SimpleQueryExecutor) {
	fake.chaincodeDefinitionMutex.RLock()
	defer fake.chaincodeDefinitionMutex.RUnlock()
