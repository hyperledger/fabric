...
func (fake *IOReadWriter) ReadDir(arg1 string) ([]fs.FileInfo, error) {
...
func (fake *IOReadWriter) ReadDirCalls(stub func(string) ([]fs.FileInfo, error)) {
	fake.readDirMutex.Lock()
...
func (fake *IOReadWriter) ReadDirReturns(result1 []fs.FileInfo, result2 error) {
	fake.readDirMutex.Lock()
	defer fake.readDirMutex.Unlock()
...
func (fake *IOReadWriter) ReadDirReturnsOnCall(i int, result1 []fs.FileInfo, result2 error) {
	fake.readDirMutex.Lock()
	defer fake.readDirMutex.Unlock()
	fake.ReadDirStub = nil
