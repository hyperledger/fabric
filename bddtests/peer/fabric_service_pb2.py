...
from peer import fabric_proposal_pb2 as peer_dot_fabric__proposal__pb2
from peer import fabric_proposal_response_pb2 as peer_dot_fabric__proposal__response__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='peer/fabric_service.proto',
  package='protos',
  syntax='proto3',
  ...
  ,
  dependencies=[peer_dot_fabric__proposal__pb2.DESCRIPTOR,peer_dot_fabric__proposal__response__pb2.DESCRIPTOR,])
...
try:
  ...
  def beta_create_Endorser_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    generated only to ease transition from grpcio<0.15.0 to grpcio>=0.15.0"""
    request_serializers = {
      ('protos.Endorser', 'ProcessProposal'): peer_dot_fabric__proposal__pb2.SignedProposal.SerializeToString,
    }
    response_deserializers = {
      ('protos.Endorser', 'ProcessProposal'): peer_dot_fabric__proposal__response__pb2.ProposalResponse.FromString,
    }
    cardinalities = {
