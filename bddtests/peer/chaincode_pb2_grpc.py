...
class ChaincodeSupportStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Register = channel.stream_stream(
        ...
        request_serializer=peer_dot_chaincode__pb2.ChaincodeMessage.SerializeToString,
        response_deserializer=peer_dot_chaincode__pb2.ChaincodeMessage.FromString,
        )
...
def add_ChaincodeSupportServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Register': grpc.stream_stream_rpc_method_handler(
          servicer.Register,
          request_deserializer=peer_dot_chaincode__pb2.ChaincodeMessage.FromString,
          response_serializer=peer_dot_chaincode__pb2.ChaincodeMessage.SerializeToString,
      ),
  }
