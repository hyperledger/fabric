...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[common_dot_common__pb2.DESCRIPTOR,peer_dot_chaincodeevent__pb2.DESCRIPTOR,peer_dot_transaction__pb2.DESCRIPTOR,])
...
_EVENT.fields_by_name['chaincode_event'].message_type = peer_dot_chaincodeevent__pb2._CHAINCODEEVENT
