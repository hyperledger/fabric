...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[peer_dot_chaincodeevent__pb2.DESCRIPTOR,peer_dot_proposal__pb2.DESCRIPTOR,google_dot_protobuf_dot_timestamp__pb2.DESCRIPTOR,])
...
ChaincodeMessage = _reflection.GeneratedProtocolMessageType('ChaincodeMessage', (_message.Message,), dict(
  ...
  __module__ = 'peer.chaincodeshim_pb2'
