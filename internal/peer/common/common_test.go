...
func TestInitCmd(t *testing.T) {
	...
	assert.Equal(t, "error", flogging.GetLoggerLevel("test"))
	flogging.MustGetLogger("chaincode")
	assert.Equal(t, flogging.DefaultLevel(), flogging.GetLoggerLevel("chaincode"))
	flogging.MustGetLogger("test.test2")
	flogging.ActivateSpec("test.test2=warn")
	assert.Equal(t, "warn", flogging.GetLoggerLevel("test.test2"))
	...
	assert.Equal(t, "debug", flogging.GetLoggerLevel("chaincode"))
	assert.Equal(t, "info", flogging.GetLoggerLevel("test"))
	assert.Equal(t, "fatal", flogging.GetLoggerLevel("test.test2"))
	assert.Equal(t, "error", flogging.GetLoggerLevel("abc"))
