...
func TestVerifyDeltaSet(t *testing.T) {
	...
	t.Run("Policy evalaution to false", func(t *testing.T) {
		...
		fakePolicy.EvaluateSignedDataReturns(errors.New("MockErr-fakePolicy.Evaluate-1557327297"))
...
func TestPolicyForItem(t *testing.T) {
	...
	fakeFooPolicy.EvaluateSignedDataReturns(errors.New("MockErr-fooPolicy-1557327481"))
	...
	fakeRootPolicy.EvaluateSignedDataReturns(errors.New("MockErr-rootPolicy-1557327456"))
