...
go.fqp.staticcheck   := honnef.co/go/tools/cmd/staticcheck@2023.1.7 # 2022.1.1 fixes the staticcheck issue with Go 1.18 "export data is newer version - update tool"
