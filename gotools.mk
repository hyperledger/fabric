...
GOTOOLS = counterfeiter gendoc ginkgo gocov gocov-xml gofumpt golangci-lint govulncheck misspell mockery protoc-gen-go protoc-gen-go-grpc staticcheck swagger
BUILD_DIR ?= build
