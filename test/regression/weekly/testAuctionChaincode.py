...
#################################################################################
    ...
    def test_FAB4176_1_Create_Channel(self):
        '''
    ...
    def test_FAB4176_2_Join_Channel(self):
        '''
            Network: 1 Ord, 2 Org, 4 Peers, 2 Chan, 1 CC
    ...
    def test_FAB4176_3_Install_Chaincode(self):
        '''
            Network: 1 Ord, 2 Org, 4 Peers, 2 Chan, 1 CC
    ...
    def test_FAB4176_4_Instantiate_Chaincode(self):
        '''
            Network: 1 Ord, 2 Org, 4 Peers, 2 Chan, 1 CC
    ...
    def test_FAB4176_5_Post_Users(self):
        '''
            Network: 1 Ord, 2 Org, 4 Peers, 2 Chan, 1 CC
    ...
    def test_FAB4176_6_Get_Users(self):
        '''
            Network: 1 Ord, 2 Org, 4 Peers, 2 Chan, 1 CC
    ...
    def test_FAB4176_7_Download_Images(self):
        '''
            Network: 1 Ord, 2 Org, 4 Peers, 2 Chan, 1 CC
    ...
    def test_FAB4176_8_Post_Items(self):
        '''
            Network: 1 Ord, 2 Org, 4 Peers, 2 Chan, 1 CC
    ...
    def test_FAB4176_9_Auction_Invoke(self):
        '''
            Network: 1 Ord, 2 Org, 4 Peers, 2 Chan, 1 CC
