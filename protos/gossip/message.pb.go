...
type GossipMessage struct {
	...
	// Used to specify the envelope the GossipMessage came from
	Envelope *Envelope `protobuf:"bytes,4,opt,name=envelope" json:"envelope,omitempty"`
	// Types that are valid to be assigned to Content:
...
func (m *GossipMessage) GetEnvelope() *Envelope {
	if m != nil {
		return m.Envelope
	}
	return nil
...
type MembershipRequest struct {
	SelfInformation *Envelope `protobuf:"bytes,1,opt,name=selfInformation" json:"selfInformation,omitempty"`
...
var fileDescriptor0 = []byte{
	...
	,
}
