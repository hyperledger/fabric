...
func (*SignedEndpoint) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{18} }
...
func (*RemoteStateRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{20} }
...
func (*RemoteStateResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{21} }
...
var fileDescriptor0 = []byte{
	...
	,
}
