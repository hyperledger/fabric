...
func (*TokenExpectation) Descriptor() ([]byte, []int) {
	return fileDescriptor_expectations_2806517d005b231f, []int{0}
}
...
func (*PlainExpectation) Descriptor() ([]byte, []int) {
	return fileDescriptor_expectations_2806517d005b231f, []int{1}
}
...
func (*PlainTokenExpectation) Descriptor() ([]byte, []int) {
	return fileDescriptor_expectations_2806517d005b231f, []int{2}
}
...
func init() {
	proto.RegisterFile("token/expectations.proto", fileDescriptor_expectations_2806517d005b231f)
}

var fileDescriptor_expectations_2806517d005b231f = []byte{
