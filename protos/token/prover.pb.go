...
type TokenOutput struct {
	...
	Id *InputId `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
...
func (m *TokenOutput) GetId() *InputId {
	if m != nil {
		return m.Id
	}
	return nil
...
type TransferRequest struct {
	Credential           []byte                    `protobuf:"bytes,1,opt,name=credential,proto3" json:"credential,omitempty"`
	TokenIds             []*InputId                `protobuf:"bytes,2,rep,name=token_ids,json=tokenIds,proto3" json:"token_ids,omitempty"`
...
func (m *TransferRequest) GetTokenIds() []*InputId {
	if m != nil {
		return m.TokenIds
	}
	return nil
...
func (m *RedeemRequest) GetTokenIds() []*InputId {
	if m != nil {
		return m.TokenIds
	}
	return nil
...
type ApproveRequest struct {
	...
	TokenIds             []*InputId `protobuf:"bytes,3,rep,name=token_ids,json=tokenIds,proto3" json:"token_ids,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (m *ApproveRequest) GetTokenIds() []*InputId {
	if m != nil {
		return m.TokenIds
	}
	return nil
...
func (m *ExpectationRequest) GetTokenIds() []*InputId {
	if m != nil {
		return m.TokenIds
	}
	return nil
...
var fileDescriptor_456ae20c2189a151 = []byte{
	...
	,
}
