...
func (PeerEndpoint_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor6, []int{2, 0} }
...
func (*PeerAddress) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (*PeerID) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
func (*PeerEndpoint) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{2} }
...
func (*PeersMessage) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{3} }
...
func (*PeersAddresses) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{4} }
...
func (*BlockchainInfo) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{5} }
...
func init() { proto.RegisterFile("peer/fabric.proto", fileDescriptor6) }
