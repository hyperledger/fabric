...
func (ServerStatus_StatusCode) EnumDescriptor() ([]byte, []int) { return fileDescriptor14, []int{0, 0} }
...
func (*ServerStatus) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{0} }
...
func (*LogLevelRequest) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{1} }
...
func (*LogLevelResponse) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{2} }
...
func init() { proto.RegisterFile("peer/server_admin.proto", fileDescriptor14) }
