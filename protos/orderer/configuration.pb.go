...
func (ConsensusType_State) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_configuration_e89d2dfdafd8f5d0, []int{0, 0}
}
...
func (*ConsensusType) Descriptor() ([]byte, []int) {
	return fileDescriptor_configuration_e89d2dfdafd8f5d0, []int{0}
}
...
func (*BatchSize) Descriptor() ([]byte, []int) {
	return fileDescriptor_configuration_e89d2dfdafd8f5d0, []int{1}
}
...
func (*BatchTimeout) Descriptor() ([]byte, []int) {
	return fileDescriptor_configuration_e89d2dfdafd8f5d0, []int{2}
}
...
func (*KafkaBrokers) Descriptor() ([]byte, []int) {
	return fileDescriptor_configuration_e89d2dfdafd8f5d0, []int{3}
}
...
func (*ChannelRestrictions) Descriptor() ([]byte, []int) {
	return fileDescriptor_configuration_e89d2dfdafd8f5d0, []int{4}
}
...
func init() {
	proto.RegisterFile("orderer/configuration.proto", fileDescriptor_configuration_e89d2dfdafd8f5d0)
}

var fileDescriptor_configuration_e89d2dfdafd8f5d0 = []byte{
