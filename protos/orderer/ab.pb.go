...
//     a) Each signature is of type common.Envelope
//     b) The common.Envelope common.Payload has data set to the hash of the ConfigurationItem
//     c) The common.Envelope common.Payload has a header with the type set to common.Header.Type.CONFIGURATION_ITEM
...
type SignedConfigurationItem struct {
	...
	Signatures    []*common.Envelope `protobuf:"bytes,2,rep,name=Signatures" json:"Signatures,omitempty"`
}
...
func (m *SignedConfigurationItem) GetSignatures() []*common.Envelope {
	if m != nil {
		return m.Signatures
	}
	return nil
...
type ConfigurationItem struct {
	...
	Type               ConfigurationItem_ConfigurationType `protobuf:"varint,3,opt,name=Type,enum=orderer.ConfigurationItem_ConfigurationType" json:"Type,omitempty"`
...
func (*DeliverResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
var fileDescriptor0 = []byte{
	...
	,
}
