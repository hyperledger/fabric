...
// If MetadataToAdd is an empty map, existing metadata for the KVS
// key are not modified. Otherwise, all keys in the MetadataToAdd
// map are inserted/updated to the metadata map that is stored on
// the ledger for the KVS key.
type KVMetadataWrite struct {
	MetadataToAdd map[string][]byte `protobuf:"bytes,1,rep,name=metadata_to_add,json=metadataToAdd" json:"metadata_to_add,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *KVMetadataWrite) GetMetadataToAdd() map[string][]byte {
	if m != nil {
...
// 2) metadata update: if Metadata.MetadataToAdd is not empty, all entries in
//    Metadata.MetadataToAdd are applied.
...
var fileDescriptor0 = []byte{
	...
	,
}
