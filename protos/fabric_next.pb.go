...
func _Endorser_ProcessProposal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(Proposal)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(EndorserServer).ProcessProposal(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
