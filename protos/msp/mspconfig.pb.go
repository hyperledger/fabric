...
func (*MSPConfig) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{0} }
...
func (*FabricMSPConfig) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{1} }
...
func (*SigningIdentityInfo) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{2} }
...
func (*KeyInfo) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{3} }
...
func (*FabricOUIdentifier) Descriptor() ([]byte, []int) { return fileDescriptor2, []int{4} }
...
func init() { proto.RegisterFile("msp/mspconfig.proto", fileDescriptor2) }
