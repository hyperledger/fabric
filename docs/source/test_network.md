...
if no channel is specified). If are using a chaincode for the first time, the
script will download the chaincode dependencies. By default, The script installs
