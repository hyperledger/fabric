...
**Important:** This tutorial is compatible with the Fabric test network sample v2.2.x. After you have installed the [prerequisites]((https://hyperledger-fabric.readthedocs.io/en/release-2.2/getting_started.html)),
