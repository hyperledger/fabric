...
* [For RST formatting](http://hyperledger-fabric.readthedocs.io/en/{BRANCH}/channel_update_tutorial.html).

* [For Markdown formatting](http://hyperledger-fabric.readthedocs.io/en/{BRANCH}/peers/peers.html).
