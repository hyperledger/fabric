...
`v1.1.1 <https://github.com/hyperledger/fabric/releases/tag/v1.1.1>`__ - July 5, 2018
---------------------------------------------------------------------------------------
...
`Change Log <https://github.com/hyperledger/fabric/blob/master/CHANGELOG.md#v111>`__
