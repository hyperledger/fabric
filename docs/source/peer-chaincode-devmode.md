...
5. Create the `hyperledger` subdirectory in the `/var` directory. This is a location Fabric uses. To create the hyperledger subdirectory, execute these commands, replacing the question marks with your username:
