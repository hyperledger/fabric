...
Use "peercli lifecycle [command] --help" for more information about a command.
```
...
Usage:
  peercli lifecycle chaincode [command]
...
Use "peercli lifecycle chaincode [command] --help" for more information about a command.
```
...
Usage:
  peercli lifecycle chaincode package [outputfile] [flags]
...
## peercli lifecycle chaincode install
```
Install a chaincode on a peer.

Usage:
  peercli lifecycle chaincode install [packageFile] [flags]
...
## peercli lifecycle chaincode queryinstalled
```
Query the installed chaincodes on a peer.

Usage:
  peercli lifecycle chaincode queryinstalled [flags]
...
## peercli lifecycle chaincode getinstalledpackage
```
Get an installed chaincode package from a peer.

Usage:
  peercli lifecycle chaincode getinstalledpackage [outputfile] [flags]
...
## peercli lifecycle chaincode calculatepackageid
```
Calculate the package ID for a packaged chaincode.

Usage:
  peercli lifecycle chaincode calculatepackageid [packageFile] [flags]
...
## peercli lifecycle chaincode approveformyorg
```
Approve the chaincode definition for my organization.

Usage:
  peercli lifecycle chaincode approveformyorg [flags]
...
## peercli lifecycle chaincode queryapproved
```
Query organization's approved chaincode definitions from its peer.

Usage:
  peercli lifecycle chaincode queryapproved [flags]
...
## peercli lifecycle chaincode checkcommitreadiness
```
Check whether a chaincode definition is ready to be committed on a channel.

Usage:
  peercli lifecycle chaincode checkcommitreadiness [flags]
...
## peercli lifecycle chaincode commit
```
Commit the chaincode definition on the channel.

Usage:
  peercli lifecycle chaincode commit [flags]
...
## peercli lifecycle chaincode querycommitted
```
...
Usage:
  peercli lifecycle chaincode querycommitted [flags]
