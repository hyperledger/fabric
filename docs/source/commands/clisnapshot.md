...
## cli snapshot cancelrequest
```
Cancel a request for a snapshot at the specified block.

Usage:
  cli snapshot cancelrequest [flags]
...
## cli snapshot listpending
```
List pending requests for snapshots.

Usage:
  cli snapshot listpending [flags]
...
Usage:
  cli snapshot submitrequest [flags]
