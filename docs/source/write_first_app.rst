...
- `JavaScript application <https://github.com/hyperledger/fabric-samples/blob/release-2.2/asset-transfer-basic/application-javascript>`__

Note that the sample application is also available in Go and Java at the links below:

- `Go application <https://github.com/hyperledger/fabric-samples/blob/release-2.2/asset-transfer-basic/application-go>`__
- `Java application <https://github.com/hyperledger/fabric-samples/blob/release-2.2/asset-transfer-basic/application-java>`__
...
- `Golang <https://github.com/hyperledger/fabric-samples/blob/release-2.2/asset-transfer-basic/chaincode-go>`__
- `Java <https://github.com/hyperledger/fabric-samples/blob/release-2.2/asset-transfer-basic/chaincode-java>`__
- `JavaScript <https://github.com/hyperledger/fabric-samples/blob/release-2.2/asset-transfer-basic/chaincode-javascript>`__
- `Typescript <https://github.com/hyperledger/fabric-samples/blob/release-2.2/asset-transfer-basic/chaincode-typescript>`__
