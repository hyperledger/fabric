...
1.  **Mission and Scope of the Project**
    ...
    1.  The mission of the Project is to build platforms for distributed ledger solutions underpinned by a modular architecture delivering high degrees of confidentiality, resiliency, flexibility, and scalability.
...
2.  **Technical Steering Committee**
    ...
    2.  **TSC Composition:** 
        ...
        1. **Initial TSC Members:** The TSC starts with maintainers from the foundational **Sub-Project**:
          - Those listed in the fabric repository MAINTAINERS file - (https://github.com/hyperledger/fabric/blob/main/MAINTAINERS.md).
          - Those listed in the fabric-gateway repository MAINTAINERS file (https://github.com/hyperledger/fabric-gateway/blob/main/MAINTAINERS.md).
        
        2. **Adding New Members:** When a new Sub-Project joins the ecosystem:
          - Its repository maintainers can become TSC members. Which repository maintainers will be added is specified in the RFC of the proposed Sub-Project.
        
        3. When adding more maintainers from an existing Sub-Project:
          - The existing TSC members from that Sub-Project must approve by majority vote.
    ...
    3.  **Roles within the Ecosystem:** The Project ecosystem generally will involve Contributors and **Sub-Project Maintainers**. The TSC may adopt or modify roles so long as the roles are documented by the TSC. Unless otherwise documented:
        ...
        2.  **Sub-Project Maintainers** are Contributors who have earned the ability to modify (“commit”) source code, documentation, or other technical artifacts in a specific recognized **Sub-Project**;
...
3.  **Sub-Project Maintainers**
    ...
    1.  **Definition:** Each officially recognized **Sub-Project** within the ecosystem shall have its own group of **Maintainers** (hereinafter "Maintainers"). These Maintainers are the individuals who can be members of the TSC as per Section 2.2.
...
4.  **Voting on Ecosystem-Wide Decisions**
    ...
    1. **Principle** Formal voting by TSC Members is required for significant ecosystem-wide decisions to ensure broad support and ecosystem integrity, supplementing general consensus-seeking.

    2. **Scope:** This process applies to significant ecosystem-wide matters, such as: (1) accepting or archiving Sub-Projects, (2) major changes to core principles or guidelines, (3) adopting or significantly altering other ecosystem-wide policies.

    3. **Ecosystem-Wide Voting Process**

        1.  **Initiation**: Proposals for ecosystem-wide decisions are reviewed by the TSC. If a formal vote is deemed necessary, the TSC initiates it, putting the matter to the TSC Members affiliated with all recognized and active Sub-Projects for their respective Sub-Project's collective vote.

        2.  **Sub-Project Collective Vote Determination:**
            
            1. Each active Sub-Project contributes one collective vote (approve/disapprove) to an ecosystem-wide decision. This vote is determined by the TSC Members affiliated with that Sub-Project.
            
            2. **Internal Voting Eligibility:** Only the TSC Members affiliated with the Sub-Project are eligible to vote in the internal process that determines the Sub-Project's collective stance.

            3. **Internal Decision Mechanism:** Typically, a **Sub-Project's** collective vote is 'approve' if a majority of its participating affiliated TSC members vote to approve the proposal; otherwise, its collective vote is 'disapprove'. Alternatively, the **Sub-Project** may use its own documented procedures for its affiliated TSC members to determine its collective vote (approve/disapprove).

        3.  **Submission & Tally:** Each group of TSC Members affiliated with a Sub-Project submits their Sub-Project's collective vote to the overall TSC.

        4. **Adoption & Announcement:** A proposal is adopted if approved by at least fifty percent of active Sub-Projects (based on their collective votes). The TSC tallies these collective votes and announces the outcome.

    4.  **Role of the TSC**: The TSC is responsible for facilitating this voting process, formally defining criteria for a **Sub-Project** to be considered "active" and thus eligible to participate, setting the precise majority threshold, ratifying the outcomes of these votes, and documenting all such decisions.

    5.  **Sub-Project Specific Matters Escalated to TSC:** For matters primarily specific to a single Sub-Project that are escalated to the TSC for guidance or resolution, and do not constitute a significant ecosystem-wide decision as listed above, the TSC may provide recommendations or make decisions by majority votes of TSC members present at a quorate meeting, or by a majority of all TSC members via electronic vote.

    6.  **Dispute Resolution:** In the event a vote under Section 4 cannot be resolved or leads to significant contention, any voting member of the TSC (representing their **Sub-Project**) may refer the matter to the Series Manager of LF Projects for assistance in reaching a resolution, in consultation with the Hyperledger Foundation.
...
10. **Amendments**
    ...
    1. This charter may be amended by a TSC vote as described in section 4, but requiring a two-thirds majority of collective sub-project votes, and is subject to approval by LF Projects.
