...
var file_peer_lifecycle_db_proto_goTypes = []any{
...
func file_peer_lifecycle_db_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_peer_lifecycle_db_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_peer_lifecycle_db_proto_msgTypes[1].Exporter = func(v any, i int) any {
	...
	file_peer_lifecycle_db_proto_msgTypes[1].OneofWrappers = []any{
		(*StateData_Int64)(nil),
		(*StateData_Bytes)(nil),
