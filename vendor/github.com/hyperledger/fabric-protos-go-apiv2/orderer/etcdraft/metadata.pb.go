...
func file_orderer_etcdraft_metadata_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_orderer_etcdraft_metadata_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_orderer_etcdraft_metadata_proto_msgTypes[1].Exporter = func(v any, i int) any {
