...
var file_smartbftprotos_messages_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69, 0x74, 0x68,
...
var (
	...
	file_smartbftprotos_messages_proto_rawDescData = file_smartbftprotos_messages_proto_rawDesc
)

func file_smartbftprotos_messages_proto_rawDescGZIP() []byte {
	file_smartbftprotos_messages_proto_rawDescOnce.Do(func() {
		file_smartbftprotos_messages_proto_rawDescData = protoimpl.X.CompressGZIP(file_smartbftprotos_messages_proto_rawDescData)
	})
...
var file_smartbftprotos_messages_proto_goTypes = []interface{}{
...
func file_smartbftprotos_messages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_smartbftprotos_messages_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Commit); i {
			case 0:
				return &v.state
			case 1:
		...
		file_smartbftprotos_messages_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_smartbftprotos_messages_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
	...
	file_smartbftprotos_messages_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	file_smartbftprotos_messages_proto_msgTypes[15].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_smartbftprotos_messages_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   18,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_smartbftprotos_messages_proto_rawDesc = nil
