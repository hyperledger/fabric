...
func TestCertificateExtraction(t *testing.T) {
	...
	require.Len(t, clientSideCertHash, 32, "client side cert hash is %v", clientSideCertHash)
	require.Len(t, serverSideCertHash, 32, "server side cert hash is %v", serverSideCertHash)
