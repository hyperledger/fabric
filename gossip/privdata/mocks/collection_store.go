...
func (_m *CollectionStore) RetrieveCollectionConfig(_a0 privdata.CollectionCriteria) (*common.StaticCollectionConfig, error) {
	ret := _m.Called(_a0)

	var r0 *common.StaticCollectionConfig
	if rf, ok := ret.Get(0).(func(privdata.CollectionCriteria) *common.StaticCollectionConfig); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*common.StaticCollectionConfig)
		}
	}
...
func (_m *CollectionStore) RetrieveCollectionConfigPackage(_a0 privdata.CollectionCriteria) (*common.CollectionConfigPackage, error) {
	ret := _m.Called(_a0)

	var r0 *common.CollectionConfigPackage
	if rf, ok := ret.Get(0).(func(privdata.CollectionCriteria) *common.CollectionConfigPackage); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
