...
func (_m *CollectionStore) RetrieveCollectionConfig(_a0 common.CollectionCriteria) (*common.StaticCollectionConfig, error) {
	ret := _m.Called(_a0)

	var r0 *common.StaticCollectionConfig
	if rf, ok := ret.Get(0).(func(common.CollectionCriteria) *common.StaticCollectionConfig); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
