...
import (
	...
	deliver_mocks "github.com/hyperledger/fabric/v2/common/deliver/mock"
	...
	cluster_mocks "github.com/hyperledger/fabric/v2/orderer/common/cluster/mocks"
	"github.com/hyperledger/fabric/v2/orderer/common/localconfig"
	onboarding_mocks "github.com/hyperledger/fabric/v2/orderer/common/onboarding/mocks"
...
func TestMain(m *testing.M) {
	var err error
	configtxgen, err = gexec.Build("github.com/hyperledger/fabric/v2/cmd/configtxgen")
	if err != nil {
