...
func (_m *ClusterStepStream) Recv() (*orderer.ClusterNodeServiceStepRequest, error) {
	...
	var r0 *orderer.ClusterNodeServiceStepRequest
	if rf, ok := ret.Get(0).(func() *orderer.ClusterNodeServiceStepRequest); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*orderer.ClusterNodeServiceStepRequest)
		}
	}
...
func (_m *ClusterStepStream) Send(response *orderer.ClusterNodeServiceStepResponse) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*orderer.ClusterNodeServiceStepResponse) error); ok {
		r0 = rf(response)
	} else {
		r0 = ret.Error(0)
	}
...
type mockConstructorTestingTNewClusterStepStream interface {
	mock.TestingT
	Cleanup(func())
}
