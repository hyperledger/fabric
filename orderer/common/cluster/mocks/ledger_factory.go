...
type mockConstructorTestingTNewLedgerFactory interface {
	mock.TestingT
	Cleanup(func())
}

// NewLedgerFactory creates a new instance of LedgerFactory. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewLedgerFactory(t mockConstructorTestingTNewLedgerFactory) *LedgerFactory {
	mock := &LedgerFactory{}
	mock.Mock.Test(t)
