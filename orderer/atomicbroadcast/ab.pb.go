...
//   2. Increment Sequence in the ConfigurationEnvelope
//   3. Modify desired ConfigurationItems, setting each LastModified to the ConfigurationEnvelope Sequence
//   4. Update SignedConfigurationItem with appropriate signatures over the modified ConfigurationItem
//     a) Each signature is of type Envelope
//     b) The Envelope Payload has data set to the hash of the ConfigurationItem
//     c) The Envelope Payload has a header with the type set to CONFIGURATION_ITEM
...
//     b) The Envelope Payload has a header of type CONFIGURATION_TRANSACTION
//
...
//   4. All configuration changes have a LastModification equal to Sequence from the ConfigurationEnvelope
...
type ConfigurationEnvelope struct {
	...
	Items    []*SignedConfigurationItem `protobuf:"bytes,3,rep,name=Items" json:"Items,omitempty"`
}
...
func (m *SignedConfigurationItem) GetSignatures() []*Envelope {
	if m != nil {
		return m.Signatures
	}
	return nil
...
type ConfigurationItem struct {
	...
	Type               ConfigurationItem_ConfigurationType `protobuf:"varint,3,opt,name=Type,enum=atomicbroadcast.ConfigurationItem_ConfigurationType" json:"Type,omitempty"`
...
func init() {
	...
	proto.RegisterType((*SignedConfigurationItem)(nil), "atomicbroadcast.SignedConfigurationItem")
	proto.RegisterType((*ConfigurationItem)(nil), "atomicbroadcast.ConfigurationItem")
	...
	proto.RegisterEnum("atomicbroadcast.ConfigurationItem_ConfigurationType", ConfigurationItem_ConfigurationType_name, ConfigurationItem_ConfigurationType_value)
...
var fileDescriptor0 = []byte{
	...
	,
}
