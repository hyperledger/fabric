...
func TestCreateNextBlock(t *testing.T) {
	...
	require.Equal(t, protoutil.BlockDataHash(second.GetData()), second.GetHeader().GetDataHash())
	...
	require.Equal(t, protoutil.BlockDataHash(third.GetData()), third.GetHeader().GetDataHash())
