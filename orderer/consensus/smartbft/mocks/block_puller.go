...
func (_m *BlockPuller) HeightsByEndpoints() (map[string]uint64, error) {
	ret := _m.Called()

	var r0 map[string]uint64
	var r1 error
	if rf, ok := ret.Get(0).(func() (map[string]uint64, error)); ok {
		return rf()
	}
...
func (_c *BlockPuller_HeightsByEndpoints_Call) Return(_a0 map[string]uint64, _a1 error) *BlockPuller_HeightsByEndpoints_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *BlockPuller_HeightsByEndpoints_Call) RunAndReturn(run func() (map[string]uint64, error)) *BlockPuller_HeightsByEndpoints_Call {
	_c.Call.Return(run)
	return _c
}
