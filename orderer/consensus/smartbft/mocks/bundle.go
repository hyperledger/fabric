...
func (_m *Bundle) ApplicationConfig() (channelconfig.Application, bool) {
	...
	var r1 bool
	if rf, ok := ret.Get(0).(func() (channelconfig.Application, bool)); ok {
		return rf()
	}
...
func (_m *Bundle) ConsortiumsConfig() (channelconfig.Consortiums, bool) {
	...
	var r1 bool
	if rf, ok := ret.Get(0).(func() (channelconfig.Consortiums, bool)); ok {
		return rf()
	}
...
func (_m *Bundle) OrdererConfig() (channelconfig.Orderer, bool) {
	...
	var r1 bool
	if rf, ok := ret.Get(0).(func() (channelconfig.Orderer, bool)); ok {
		return rf()
	}
