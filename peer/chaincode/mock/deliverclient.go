...
type DeliverClient struct {
	DeliverStub        func(ctx context.Context, opts ...grpc.CallOption) (api.Deliver, error)
	...
	DeliverFilteredStub        func(ctx context.Context, opts ...grpc.CallOption) (api.Deliver, error)
...
func (fake *DeliverClient) Deliver(ctx context.Context, opts ...grpc.CallOption) (api.Deliver, error) {
...
func (fake *DeliverClient) DeliverReturns(result1 api.Deliver, result2 error) {
...
func (fake *DeliverClient) DeliverReturnsOnCall(i int, result1 api.Deliver, result2 error) {
	fake.DeliverStub = nil
...
func (fake *DeliverClient) DeliverFiltered(ctx context.Context, opts ...grpc.CallOption) (api.Deliver, error) {
...
func (fake *DeliverClient) DeliverFilteredCallCount() int {
	fake.deliverFilteredMutex.RLock()
	defer fake.deliverFilteredMutex.RUnlock()
	return len(fake.deliverFilteredArgsForCall)
}

func (fake *DeliverClient) DeliverFilteredArgsForCall(i int) (context.Context, []grpc.CallOption) {
	fake.deliverFilteredMutex.RLock()
	defer fake.deliverFilteredMutex.RUnlock()
	return fake.deliverFilteredArgsForCall[i].ctx, fake.deliverFilteredArgsForCall[i].opts
}

func (fake *DeliverClient) DeliverFilteredReturns(result1 api.Deliver, result2 error) {
...
func (fake *DeliverClient) DeliverFilteredReturnsOnCall(i int, result1 api.Deliver, result2 error) {
	fake.DeliverFilteredStub = nil
