...
.PHONY: unit-test
unit-test: unit-test-clean docker-couchdb-thirdparty
...
docker-thirdparty: docker-couchdb-thirdparty
...
.PHONY: docker-couchdb-thirdparty
docker-couchdb-thirdparty:
