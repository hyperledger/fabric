...
#   - test-clean - clean persistent files generated by tests, such as JUnit reports
...
integration-test: test-clean gotool.ginkgo ccenv-docker baseos-docker docker-thirdparty
...
.PHONY: unit-test
unit-test: test-clean docker-thirdparty ccenv-docker baseos-docker gotool.gotestsum
...
.PHONY: test-clean
test-clean:
	@find . -type f -name 'fabric_*_report.xml' -delete
