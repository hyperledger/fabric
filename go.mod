...
require (
	...
	github.com/IBM/idemix/bccsp/schemes/weak-bb v0.0.0-20231003085036-c4470b87b2d6 // indirect
	github.com/IBM/idemix/bccsp/types v0.0.0-20231003085036-c4470b87b2d6 // indirect
